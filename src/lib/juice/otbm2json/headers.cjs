module.exports = {
    ...
    "OTBM_ATTR_DREAM_AREA_ID": 0x17, // ID of the dream area this tile belongs to
    "OTBM_ATTR_DREAM_SUBAREA_ID": 0x18, // ID of sub area
    "OTBM_ATTR_DREAM_WEATHER_ID": 0x19, // ID of weather area
    "OTBM_ATTR_DREAM_AREA_TYPE_ID": 0x1A, // Generic format: type followed by ID
    "OTBM_ATTR_TAGS": 0x1B,
